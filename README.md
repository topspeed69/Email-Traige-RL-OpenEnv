...
## Baseline Scores
Testing the `inference.py` script via various models yields the following reproducible scores reflecting the increasing difficulty:

### Heuristic
```text
==================================================
BASELINE RESULTS                         Time: 5:00
==================================================
easy      : 0.610
medium    : 0.527
hard      : 0.584
